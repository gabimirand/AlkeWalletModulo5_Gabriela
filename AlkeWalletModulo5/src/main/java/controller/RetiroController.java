...
public class RetiroController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)  
    	...
    	request.setAttribute("saldo", daoUsuario.retiroFondos(0)); //LLAMAR MÉTODO REALIZAR RETIRO
    	
    	System.out.println(daoUsuario.retiroFondos(0)); //LLAMAR MÉTODO REALIZAR RETIRO			
